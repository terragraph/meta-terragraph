...
SRC_URI = "${SAVANNAH_GNU_MIRROR}/${BPN}/${BP}.tar.gz \
    file://gpsd.init \
"
SRC_URI[md5sum] = "826c485a5f3165d171cd6b95798bb93d"
SRC_URI[sha256sum] = "65504c3af8d3b0cce3c07405b8815d7730d2d2be2da7d28d275f1a9c57c6fe91"
...
FILES_${PN}-doc += "${datadir}/gpsd/doc"

# Used by xgps and xgpsspeed test programs
FILES_${PN}-dev += "${datadir}/gpsd/icons"
